...
public class UpdateCart extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        if (submit.equalsIgnoreCase("-")) {
            item.delete(cartID, productID);
        } else {
//            if(quantity > pr.getProductByID(productID).getStockQuantity())
//            {
//                quantity = pr.getProductByID(productID).getStockQuantity();
//            }
            item.update(cartID, productID, quantity);
        }
