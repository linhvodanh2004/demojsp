                            ...
                            <ul style="position: relative">
                                ...
                                <li> 
                                    ...
                                    <ul class='sub-menu' style="position: absolute; z-index: 1000; top: 50px; left: 0px;">
                                        ...
                                        <li style="width: 200px; padding: 0px; background-color: #3498db"><a href="LoadOrderForUser" style="padding: 0px; color: white"><h4>Đổi mật khẩu<i class='fas fa-sign-out-alt'></i></h4></a>
...
Orders order = o.getOrderByID(orderId);
            ...
            <div class="summary-section">
                ...
                <div class="total-cost">
                    <p>Tổng thanh toán: <fmt:formatNumber value="<%= order.getPaidPrice() %>" type="number" groupingUsed="true"></fmt:formatNumber> VND</p>
                </div>
                <div class="buttons">
