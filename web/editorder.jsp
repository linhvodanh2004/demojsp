...
<html>
    ...
    <body>
        ...
        <form action="ReupdateOrder" method="post">
    ...
    Orders order = o.getOrderByID(orderId);
                ...
                <div class="form-section">
                    ...
                    <div class="form-group">
                        ...
                        <span style="font-weight: 400"> Thanh toán khi nhận hàng</span>
                    </div>

                    <div class="form-group">
                        <label>Phương thức vận chuyển</label>
                        <input type="radio" id="economical" name="shipping" value="economical"
                               onchange="getShippingFee(); getPaid()" checked>
                        <span style="font-weight: 400"> Giao hàng tiết kiệm </span>
                        <span style="font-style: italic; font-size: smaller">(Tối đa 5-7 ngày)</span>
                        <br>
                        <input type="radio" id="fast" name="shipping" value="fast"
                               onchange="getShippingFee(); getPaid()">
                        <span style="font-weight: 400"> Giao hàng nhanh </span>
                        <span style="font-style: italic; font-size: smaller">(Tối đa 3 ngày)</span>
                    </div>
                </div>
                ...
                <div class="summary-section">
                    ...
                    <input type="hidden" name="orderid" value=" <%= request.getParameter("orderid").trim() %> ">
                    <% List<Products> pr = dao.getAll(); %>
                    ...
                    <div class="buttons">
                        <button style="background-color: #2196F3" class="cancel-btn" onclick="window.location.href = 'LoadOrderForUser'" type="button">Trở về</button>
                        <button style="background-color: #4CAF50" class="submit-btn" type="submit" name="submit" value="save">Cập nhật</button>
                        <button style="background-color: #f44336" class="submit-btn" type="submit" name="submit" value="cancel"">Huỷ đơn hàng</button>
